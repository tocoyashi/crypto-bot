...
# ✨✨ الصق رابط صورة قناتك هنا بين علامات التنصيص ✨✨
    ...
    for symbol in SYMBOLS:
        try:
            ...
            if ema_buy or macd_buy:
                ...
                tp1 = round(entry * 1.015, decimals)
                tp2 = round(entry * 1.03, decimals)
                sl = round(entry * 0.985, decimals)
                ...
                entry = round(current_close, decimals)
                tp1 = round(entry * 0.985, decimals)
                tp2 = round(entry * 0.97, decimals)
                sl = round(entry * 1.015, decimals)
