...
⚙️ <b>Leverage:</b> <code>{leverage}x</code>
━━━━━━━━━━━━━━━
✅ <b>Target 1 (TP1):</b> <code>{tp1}</code>
✅ <b>Target 2 (TP2):</b> <code>{tp2}</code>
❌ <b>Stop Loss (SL):</b> <code>{sl}</code>
━━━━━━━━━━━━━━━
⚠️ <i>Automated signal based on EMA Crossover. Trade responsibly.</i>
    """
    ...
    try:
        ...
        print(f"✅ {coin_name} signal sent successfully!")
    except Exception as e:
        print(f"❌ Error sending {coin_name} signal: {e}")

def analyze_and_trade():
    print(f"\n[{datetime.now().strftime('%H:%M:%S')}] Starting market scan...")
    ...
    for symbol in SYMBOLS:
        try:
            ...
            if prev_ema9 < prev_ema21 and curr_ema9 > curr_ema21:
                print(f"🟢 BUY SIGNAL DETECTED on {symbol}!")
            ...
            # SELL SIGNAL
                ...
                print(f"🔴 SELL SIGNAL DETECTED on {symbol}!")
                entry = round(current_close, 2)
