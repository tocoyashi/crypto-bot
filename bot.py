    ...
    for symbol in SYMBOLS:
        try:
            ...
            if ema_buy or macd_buy:
                ...
                send_crypto_signal(symbol, "LONG", strategy_name, str(entry), "10", str(tp1), str(tp2), str(tp3), str(tp4), str(tp5), str(sl), DEFAULT_IMAGE)
                time.sleep(2)
                ...
                send_crypto_signal(symbol, "SHORT", strategy_name, str(entry), "10", str(tp1), str(tp2), str(tp3), str(tp4), str(tp5), str(sl), DEFAULT_IMAGE)
                time.sleep(2)
            else:
